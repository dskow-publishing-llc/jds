...
public class PubMedPubDateItemC {
	...
	private PubMedPubDateItemC articleIdList = null;

	public PubMedPubDateItemC history(HistoryC history) {
	...
	public PubMedPubDateItemC publicationStatus(String publicationStatus) {
	...
	public PubMedPubDateItemC articleIdList(PubMedPubDateItemC articleIdList) {
	 ...
	 **/
	@ApiModelProperty(example = "null", value = "A header")
	public PubMedPubDateItemC getArticleIdList() {
		return articleIdList;
	}

	public void setArticleIdList(PubMedPubDateItemC articleIdList) {
		this.articleIdList = articleIdList;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		PubMedPubDateItemC pubMedPubDateItemC = (PubMedPubDateItemC) o;
		return Objects.equals(this.history, pubMedPubDateItemC.history)
				&& Objects.equals(this.publicationStatus, pubMedPubDateItemC.publicationStatus)
				&& Objects.equals(this.articleIdList, pubMedPubDateItemC.articleIdList);
	}
	...
	public String toString() {
		...
		sb.append("class PubMedPubDateItemC {\n");
